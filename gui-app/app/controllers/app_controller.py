...
class AppController:
    ...
    def execute_query(self, config: ServerConfig, query: str):
    ...
    def run_benchmark(self, queries: list[str], policies: list[str], frames: int):
        return self.benchmark_service.run(queries=queries, policies=policies, frames=frames)
